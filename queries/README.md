...
[`provenance/Competency Questions.xlsx`](../provenance/Competency%20Questions.xlsx) - on
the "Competency Questions" sheet where a compliance process asks the question, and on
"Extra" otherwise.
